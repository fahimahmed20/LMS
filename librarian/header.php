...
<link rel="icon" type="../assets/image/png" sizes="192x192" href="favicon/android-icon-192x192.png">
<link rel="icon" type="../assets/image/png" sizes="32x32" href="favicon/favicon-32x32.png">
<link rel="icon" type="../assets/image/png" sizes="16x16" href="favicon/favicon-16x16.png">
<!--load progress bar-->
...
<div class="left-sidebar">
    ...
    <div class="left-sidebar-header">
        <div class="left-sidebar-title"><h3 style="margin: 0;">Navigation</h3></div>
